...
namespace MVC2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.DocumentypeID = new SelectList(db.DocumentTypes, "DocumentypeID", "Description");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirtsName,LastName,Salary,BonusPercent,DateOfBirth,Startiem,Email,Url,DocumentypeID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
